    ...
    resources: {
      zh: {
        translation: {
          ...
          "poolGrowth": "奖池每小时自动增长",
          "estimatedAfterSettlement": "结算后计算",
          "settledAfterHourly": "每小时结算后发放",
          ...
          "hourlyDistribution": "每小时分配",
          "hourlyDistributionDesc": "每小时分配总投注的 10% 作为奖励",
          ...
          "step2DetermineDistribution": "第二步：确定每小时分配金额",
          "step2Desc": "每小时分配总投注的 10% 作为奖励",
      ...
      en: {
        translation: {
          ...
          "settlementFrequency": "Settles automatically every hour",
          ...
          "poolGrowth": "Reward pool grows automatically every hour",
          "estimatedAfterSettlement": "Calculated after settlement",
          "settledAfterHourly": "Distributed after each hourly settlement",
          ...
          "hourlyDistributionDesc": "10% of total allocations distributed hourly as rewards",
          ...
          "step2DetermineDistribution": "Step 2: Determine Hourly Distribution",
          "step2Desc": "10% of total allocations distributed as rewards each hour",
          ...
          "hourlySettlement": "Settles automatically every hour",
